...
import com.itanelse.mobileguard.engine.PhoneLocationEngine;
...
public class ComingPhoneService extends Service {
	...
	int bgStyles[] = new int[] { R.drawable.call_locate_blue,
	...
	private void initToastParams() {
		...
		/* | WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE */// 注释掉不能触摸
		...
		params.type = WindowManager.LayoutParams.TYPE_PRIORITY_PHONE;// 土司天生不响应事件,改变类型
