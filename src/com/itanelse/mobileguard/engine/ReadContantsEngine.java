...
public class ReadContantsEngine {
	 ...
	 * @return 电话日志的记录
	 */
	public static List<ContactInfo> readSmslog(Context context) {
		// 1，电话日志的数据库
	 ...
	 * @return 电话日志的记录
	 */
	public static List<ContactInfo> readCalllog(Context context) {
		// 1，电话日志的数据库
		// 2,通过分析，db不能直接访问，需要内容提供者访问该数据库
	 ...
	 * 读取手机联系人
	 */
	public static List<ContactInfo> readContants(Context context) {
		List<ContactInfo> datas = new ArrayList<ContactInfo>();
